...
Dinosaur dinoCreator() {
	...
	while (true) {
		...
		default: cout << "No such gender. Enter dinosaur data again!" << endl; flag = false; continue;
		}
		cout << endl;
		...
		default: cout << "No such era. Enter dinosaur data again!" << endl; flag = false; continue;
		}
		...
		default: cout << "No such group. Enter dinosaur data again!" << endl; flag = false; continue;
		}
		...
		default: cout << "No such food. Enter dinosaur data again!"<< endl; flag = false; continue;
		}
		if (flag) {
...
void help() {
	...
	cout << "-----------------------------------------------------------------" << endl;
	cout << "exit - terminates the program and saves data." << endl;
	cout << "-----------------------------------------------------------------" << endl;
